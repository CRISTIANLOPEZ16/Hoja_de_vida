...
$boton.html("Validando<img src='img/carga.gif' width=10%;>");
$boton.attr("class","btn btn-danger");
ajax=__ajax("peticiones/recoger.php",usuario,clave);
setTimeout(function(){
...
$boton.html("Verificando<img src='img/carga.gif' width=10%;>");
$boton.attr("class","btn btn-danger");
ajax=__ajax("peticiones/crearUsuario.php",usuario,clave);
ajax.done(function(respon){
